      ...
      <section class="intro-section" id="home">
        <v-row class="align-center px-10" style="height: 690px">
          <v-col lg="6" cols="6" class="pa-6 font-weight-bold py-16">
            ...
            <v-subheader
              >Hi, I am Jack, focusing on creating emotional
        ...
        >
          <v-container>
            <h4 class="display-1 text-center mb-5">
              I’m a designer, based in San Francisco. Currently a freelancer.
              You can see my hobbies on @Jack-Co and some photos on me too.
            </h4>
            <v-divider />
            <br />
            <v-row>
            ...
            <v-col class="text-center" cols="12">
              <strong
                ...
                <a href="" class="green--text"
                  >Portfolio<span class="pink--text">.in</span></a
                >
              </strong>
            </v-col>
          </v-footer>
